...
• Remove the last two names from your list, so you have an empty list.
 ...
 of your program.*/
var list_ = ["Mariyam", "Maliha", "Hurmat"];
var _absentGuest = "Mariyam";
var _newGuest = "Abrish";
list_[0] = _newGuest;
console.log("".concat(_absentGuest, " is not coming to the party\n."));
console.log("Good news! We find big table so we are inviting 3 more guest\n");
list_.unshift("Ayeza");
list_.splice(2, 0, "Sana");
list_.push("Dua");
for (var i = 0; i < list_.length; i++) {
    console.log("Dear ".concat(list_[i], " It is our pleasure to invite you in our party.\nThank You!\n"));
}
console.log("sorry  we can not arrange big table,only two people will be invited.");
while (list_.length > 2) {
    var removeGuest = list_.pop();
    console.log("Sorry ".concat(removeGuest, ", you are not invited for dinner"));
}
for (var i = 0; i < list_.length; i++) {
    console.log("Dear ".concat(list_[i], " you are still invited.\nThank You!\n"));
}
list_.splice(0, 2);
console.log(list_);
