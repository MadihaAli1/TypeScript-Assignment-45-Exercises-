...
const alien_color_version3: string = 'green';
...
const alien_color_version4: string = 'red';
...
const alien_color_version5: string = 'green';
...
const alien_color_version6: string = 'yellow';
...
const alien_color_version7: string = 'red';
